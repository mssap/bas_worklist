		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Order List",
									"targetURL": "#comboschcoworklist-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comboschcoworklist-display": {
								"semanticObject": "comboschcoworklist",
								"action": "display",
								"description": "Order list display",
								"title": "Order List",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.bosch.co.worklist",
									"url": sap.ui.require.toUrl("com/bosch/co/worklist")
								}
							}
						}
					}
